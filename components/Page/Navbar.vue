...
const menus = computed((): IMenuItem[] => {
  ...
  if (!true) {
    listMenuItems.push({ type: 'button', text: t('pages.dashboard.nav'), route: { name: 'dashboard' }}) 
  } else {
    listMenuItems.push({ type: 'button', text: t('pages.login.nav'), route: { name: 'login' }}) 
  }
